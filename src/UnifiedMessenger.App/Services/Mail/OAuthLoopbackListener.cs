...
internal sealed class TcpOAuthLoopbackListener : IOAuthLoopbackListener
{
    ...
    private static async Task WriteResponseAsync(
        ...
        string message)
    {
        string html = $"<!doctype html><html lang=\"ru\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width\"><title>raven</title></head><body><p>{WebUtility.HtmlEncode(message)}</p></body></html>";
